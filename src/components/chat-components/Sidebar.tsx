      ...
      <div className="pb-5">
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5">
          ...
          <input
            ...
            className="text-white border-none outline-none text-sm flex-1 bg-transparent"
        ...
        {filteredUsers.map((user) => (
          ...
          >
            ...
            {unreadCounts[user.uid] > 0 && (
              <div className="ml-auto bg-red-500 text-xs font-bold w-6 h-6 flex items-center justify-center rounded-full">
